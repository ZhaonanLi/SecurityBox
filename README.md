...
[3] refresh symmetric key:`[RSA encryption]`
* (a) Request:
```json
    URL: http://hostname:port_num/security_box_api/refresh_symmetric_key_service.php
...
[6] download file:`[AES encryption]`
* (a) Request:
```json
